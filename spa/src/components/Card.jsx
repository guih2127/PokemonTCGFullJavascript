...
export default class Card extends Component {
    render() {
        return(
            <div style={{"border": "solid 1px black", "padding": "10px", "margin": "10px", "width": "300px", "height": "450px", "fontSize": "10px"}}>
                ...
                {this.props.cardType === "Trainer" &&
                    <div>
                        <span style={{"fontWeight": "bold"}}>Effect: </span> {this.props.effect}
                    </div>
                }
                {this.props.cardType === "Pokémon" && 
                    <div>
                        <div>
